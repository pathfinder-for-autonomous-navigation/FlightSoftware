...
bool Piksi::setup() {
    ...
    registration_successful |= sbp_register_callback(&_sbp_state, SBP_MSG_IAR_STATE, 
        &Piksi::_iar_callback, this, &Piksi::_iar_callback_node);
...
unsigned short int Piksi::get_uart_a_crc_error_count() { return _uart_state.uart_a.crc_error_count; }
unsigned short int Piksi::get_uart_a_io_error_count() { return _uart_state.uart_a.io_error_count; }
unsigned char Piksi::get_uart_a_tx_buffer_utilization() { return _uart_state.uart_a.tx_buffer_level; }
unsigned char Piksi::get_uart_a_rx_buffer_utilization() { return _uart_state.uart_a.rx_buffer_level; }
...
unsigned short int Piksi::get_uart_b_crc_error_count() { return _uart_state.uart_b.crc_error_count; }
unsigned short int Piksi::get_uart_b_io_error_count() { return _uart_state.uart_b.io_error_count; }
unsigned char Piksi::get_uart_b_tx_buffer_utilization() { return _uart_state.uart_b.tx_buffer_level; }
unsigned char Piksi::get_uart_b_rx_buffer_utilization() { return _uart_state.uart_b.rx_buffer_level; }
...
void Piksi::send_user_data(const msg_user_data_t &data)  {
    sbp_send_message(&_sbp_state, SBP_MSG_USER_DATA, SBP_SENDER_ID,
        sizeof(msg_user_data_t), (unsigned char*) &data, &Piksi::_uart_write);
}
