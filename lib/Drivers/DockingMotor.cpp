...
DockingMotor::DockingMotor(const std::string &name, unsigned char i1,
                           unsigned char i2, unsigned char dir,
                           unsigned char sleep, unsigned char step)
    : Device(name), i1_pin_(i1), i2_pin_(i2), direction_pin_(dir),
      sleep_pin_(sleep), stepper_pin_(step) {}
