...
#define I2C_INITIALIZATION                                                     \
  I2CDevice("gomspace", Gomspace::wire, Gomspace::address, 10000)
#endif

Gomspace::Gomspace(Gomspace::eps_hk_t *hk_data,
                   Gomspace::eps_config_t *config_data,
                   Gomspace::eps_config2_t *config2_data)
    : I2C_INITIALIZATION, hk(hk_data), gspace_config(config_data),
