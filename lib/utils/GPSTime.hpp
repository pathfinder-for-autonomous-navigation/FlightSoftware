...
struct gps_time_t {
    ...
    /** Comparison operator **/
    bool operator>(const gps_time_t &t1) { return !(this->operator<(t1) || this->operator==(t1)); }
    ...
    explicit operator unsigned int() { return gpstime.wn * MILLISECONDS_IN_WEEK + gpstime.tow; }
};
