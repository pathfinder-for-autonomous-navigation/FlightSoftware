...
class Serializer<unsigned int, unsigned int, csz> : public SerializerBase<unsigned int> {
   public:
    ...
    bool serialize(const unsigned int &src, std::bitset<csz> *dest) {
        if (!_is_initialized) return false;
    ...
    bool deserialize(const std::bitset<csz> &src, unsigned int *dest) {
        if (!_is_initialized) return false;
...
class Serializer<signed int, signed int, csz> : public SerializerBase<signed int> {
   public:
    ...
    bool serialize(const signed int &src, std::bitset<csz> *dest) {
        if (!_is_initialized) return false;
    ...
    bool deserialize(const std::bitset<csz> &src, signed int *dest) {
        if (!_is_initialized) return false;
        *dest = _min + src.to_ulong() * _resolution();
        return true;
    }
...
class Serializer<float, float, csz> : public SerializerBase<float> {
   public:
    ...
    bool serialize(const float &src, std::bitset<csz> *dest) {
        if (!_is_initialized) return false;
    ...
    bool deserialize(const std::bitset<csz> &src, float *dest) {
        if (!_is_initialized) return false;
...
class Serializer<double, double, csz> : public SerializerBase<double> {
   public:
    ...
    bool serialize(const double &src, std::bitset<csz> *dest) {
        if (!_is_initialized) return false;
    ...
    bool deserialize(const std::bitset<csz> &src, double *dest) {
        if (!_is_initialized) return false;
...
class Serializer<f_vector_t, float, csz> : public SerializerBase<float> {
   public:
    ...
    bool serialize(const f_vector_t &src, std::bitset<csz> *dest) {
        if (!_is_initialized) return false;
    ...
    bool deserialize(const std::bitset<csz> &src, f_vector_t *dest) {
        if (!_is_initialized) return false;
        ...
        for (int i = 0; i < 3; i++) (*dest)[i] *= magnitude;
...
class Serializer<d_vector_t, double, csz> : public SerializerBase<double> {
   public:
    ...
    bool serialize(const d_vector_t &src, std::bitset<csz> *dest) {
        if (!_is_initialized) return false;
    ...
    bool deserialize(const std::bitset<csz> &src, d_vector_t *dest) {
        if (!_is_initialized) return false;
        ...
        for (int i = 0; i < 3; i++) {
            if (i != missing_component) {
                ...
                for (int k = 0; k < d_vec_component_sz; k++)
                    vec_component_packed.set(
                        k,
                        src[csz - d_vec_component_sz + 2 + j * d_vec_component_sz + k]);
...
class Serializer<gps_time_t, bool, SerializerConstants::gps_time_sz> : public SerializerBase<bool> {
   public:
    ...
    bool serialize(const gps_time_t &src, std::bitset<gps_time_sz> *dest) {
        ...
        for (int i = 0; i < 16; i++) dest->set(i + 1, wn[i]);
        for (int i = 0; i < 32; i++) dest->set(i + 17, tow[i]);
    ...
    bool deserialize(const std::bitset<gps_time_sz> &src, gps_time_t *dest) {
        ...
        std::bitset<16> wn;
        std::bitset<32> tow;
        for (int i = 0; i < 16; i++) wn.set(i + 1, src[i]);
        for (int i = 0; i < 32; i++) tow.set(i + 1, src[16 + i]);
