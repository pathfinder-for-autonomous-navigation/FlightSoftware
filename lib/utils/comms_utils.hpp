...
/** @{ */
/** \namespace Comms
 * Contains functions and constants related to communication packet
 * serialization and deserialization.
 * */
namespace Comms {
//! Number of bits for squeezing GPS time
constexpr size_t GPSTIME_SIZE = 49;
//! Number of bits to squeeze a number in the range +/- sqrt(2) for float vector
//! compression
 ...
 *  @param[in] min_magnitude Minimum possible magnitude of vector. May be a
 * negative number.
 *  @param[in] max_magnitude Maximum possible magnitude of vector. May be a
 * negative number.
 ...
 *  @param[in] v Vector to compress.
 *  @param[in] max_magnitude Maximum possible magnitude of vector. May be a
 * negative number. (The minimum is assumed to be zero).
 *  @param[out] result Destination bitstring for storing the compressed vector.
 * **/
template <size_t max_vec_size>
typename std::enable_if<(max_vec_size > MAX_NORMALIZED_FLOAT_VECTOR_SIZE), void>::type trim_vector(
 ...
 *  @param[out] result Float array into which the uncompressed vector should be
 * stored.
 * **/
template <size_t max_vec_size>
 ...
 *  @param[in] min_magnitude Minimum possible magnitude of vector.
 *  @param[in] max_magnitude Maximum possible magnitude of vector.
 *  @param[out] result Double array into which the uncompressed vector should be
 * stored.
 * **/
template <size_t max_vec_size>
