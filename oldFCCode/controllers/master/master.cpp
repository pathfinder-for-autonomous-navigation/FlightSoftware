...
static void check_docking_switch() {
    ...
    State::write(State::Master::docking_switch_pressed, Devices::docking_switch->pressed(),
                 master_state_lock);
    ...
    switch (master_state_copy) {
        case MasterState::DETUMBLE: {
            ...
            if (State::read(State::Master::is_deployed, master_state_lock) &&
                ...
                State::write(State::ADCS::adcs_state, State::ADCS::ADCSState::ADCS_DETUMBLE,
            ...
            switch (pan_state_copy) {
                ...
                case PANState::STANDBY: {
                    ...
                    bool adcs_is_pointing =
                        State::read(State::ADCS::adcs_state, State::ADCS::adcs_state_lock);
                    bool uplink_commanding_adcs = State::read(
                        State::Quake::most_recent_uplink.command_adcs, State::Quake::uplink_lock);
