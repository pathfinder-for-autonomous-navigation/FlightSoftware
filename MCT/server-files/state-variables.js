...
module.exports= {
  ...
  get_hk: {get_hk: true, override:false, persistence: false, suppress: false, unsignal:false},
  low_batt: {low_batt: true, override: true, persistence: true, suppress: true, unsignal: false},
