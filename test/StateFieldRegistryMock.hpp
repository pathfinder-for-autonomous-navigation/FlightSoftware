...
public:
   ...
   */
  template <typename T>
  std::shared_ptr<InternalStateField<T>>
  ...
  /**
   * @brief Create a readable state field for booleans, GPS times, and
   * float/double quaternions.
   *
   * @param name Name of field.
   * @return Pointer to field that was created.
   */
  template <typename T>
  std::shared_ptr<ReadableStateField<T>>
  create_readable_field(const std::string &name) {
    static_assert(std::is_same<T, bool>::value ||
                  ...
                  "Type argument for field creation with the given parameters "
                  "was invalid.");
  ...
  /**
   * @brief Create a writable state field for booleans, GPS times, and
   * float/double quaternions.
   *
   * @param name Name of field.
   * @return Pointer to field that was created.
   */
  template <typename T>
  std::shared_ptr<WritableStateField<T>>
  create_writable_field(const std::string &name) {
    static_assert(std::is_same<T, bool>::value ||
                      std::is_same<T, gps_time_t>::value ||
                      std::is_same<T, f_quat_t>::value ||
                      std::is_same<T, d_quat_t>::value ||
  ...
  /**
   * @brief Create a readable field for signed/unsigned ints, and floats/doubles
  ...
  template <typename T>
  std::shared_ptr<ReadableStateField<T>>
  create_readable_field(const std::string &name, T min, T max, size_t bitsize) {
  ...
  /**
   * @brief Create a writable field for signed/unsigned ints, and floats/doubles
   * and add it to the registry.
   *
   * @tparam T Type of object.
   * @param name Name of field to create.
  ...
  template <typename T>
  std::shared_ptr<WritableStateField<T>>
  create_writable_field(const std::string &name, T min, T max, size_t bitsize) {
    static_assert(std::is_same<T, signed int>::value ||
                      std::is_same<T, unsigned int>::value ||
                      std::is_same<T, signed char>::value ||
                      std::is_same<T, unsigned char>::value ||
  ...
  template <typename T>
  std::shared_ptr<ReadableStateField<T>>
  create_readable_field(const std::string &name, T min, T max) {
    static_assert(std::is_same<T, signed int>::value ||
                      std::is_same<T, unsigned int>::value ||
                      std::is_same<T, signed char>::value ||
                      std::is_same<T, unsigned char>::value,
  ...
  template <typename T>
  std::shared_ptr<WritableStateField<T>>
  create_writable_field(const std::string &name, T min, T max) {
    static_assert(std::is_same<T, signed int>::value ||
                      std::is_same<T, unsigned int>::value ||
                      std::is_same<T, signed char>::value ||
                      std::is_same<T, unsigned char>::value,
  ...
  template <typename T>
  std::shared_ptr<ReadableStateField<T>>
  create_readable_field(const std::string &name, T max) {
  ...
  template <typename T>
  std::shared_ptr<WritableStateField<T>>
  create_writable_field(const std::string &name, T max) {
    static_assert(std::is_same<T, unsigned int>::value ||
                      std::is_same<T, unsigned char>::value,
                  "Type argument for field creation with the given parameters "
                  "was invalid.");
   ...
   */
  template <typename T>
  std::shared_ptr<ReadableStateField<std::array<T, 3>>>
  create_readable_vector_field(const std::string &name, T min, T max,
                               size_t bitsize) {
   ...
   */
  template <typename T>
  std::shared_ptr<WritableStateField<std::array<T, 3>>>
  create_writable_vector_field(const std::string &name, T min, T max,
                               size_t bitsize) {
    static_assert(std::is_same<T, float>::value ||
                      std::is_same<T, double>::value,
                  "Type argument for field creation with the given parameters "
...
private:
  ...
  // to prevent segmentation faults due to shared pointers going out of scope
  // before a ControlTask has a chance to call find_readable_field().
