...
class TestFixture {
  public:
    ...
    TestFixture() : registry() {
        ...
        adcs_vec1_current_fp = registry.find_writable_field_t<lin::Vector3f>("attitude.pointer_vec1_current");
        adcs_vec1_desired_fp = registry.find_writable_field_t<lin::Vector3f>("attitude.pointer_vec1_desired");
        adcs_vec2_current_fp = registry.find_writable_field_t<lin::Vector3f>("attitude.pointer_vec2_current");
        adcs_vec2_desired_fp = registry.find_writable_field_t<lin::Vector3f>("attitude.pointer_vec2_desired");
