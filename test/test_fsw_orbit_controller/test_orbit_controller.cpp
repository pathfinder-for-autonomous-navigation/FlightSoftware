...
void test_task_schedule_valves_helper(lin::Vector3d J_body){
        ...
        unsigned int t2 = tf.orbit_controller->sched_valve2_fp->get();
        double j2 = (t2-7.0092e-05) / (0.024119*1000);
        unsigned int t3 = tf.orbit_controller->sched_valve3_fp->get();
        double j3 = (t3-7.0092e-05) / (0.024119*1000);
        unsigned int t4 = tf.orbit_controller->sched_valve4_fp->get();
