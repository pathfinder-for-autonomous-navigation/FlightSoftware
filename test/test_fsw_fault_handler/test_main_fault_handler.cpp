...
class TestFixtureMainFH {
  ...
  public:
    ...
    TestFixtureMainFH() {
        ...
        adcs_wheel1_adc_fault_fp = registry.create_fault("adcs_monitor.wheel1_fault_base", 1, cc);
        adcs_wheel2_adc_fault_fp = registry.create_fault("adcs_monitor.wheel2_fault_base", 1, cc);
        adcs_wheel3_adc_fault_fp = registry.create_fault("adcs_monitor.wheel3_fault_base", 1, cc);
        adcs_wheel_pot_fault_fp = registry.create_fault("adcs_monitor.wheel_pot_fault_base", 1, cc);
        low_batt_fault_fp = registry.create_fault("gomspace.low_batt_base", 1, cc);
        prop_failed_pressurize_fault_fp = registry.create_fault("prop.failed_pressurize_base", 1, cc);
        prop_overpressure_fault_fp = registry.create_fault("prop.overpressured_base", 1, cc);
