...
void test_uint_serializer() {
   ...
   */
  Serializer<unsigned int, unsigned int, 10>
      serializer; // 2^10 = 1024, which is greater than 20
   ...
   * represented correctly.
   */
  Serializer<unsigned int, unsigned int, 4>
      serializer2; // 2^4 = 16, which is less than 20
