...
class TestFixture {
    public:
        ...
        TestFixture() : registry(), adcs(Wire, Devices::ADCS::ADDRESS) 
        {
            ...
            adcs_functional_fault_p = find_fault("adcs_monitor.functional_fault.base");
            wheel1_adc_fault_p = find_fault("adcs_monitor.wheel1_fault.base");
            wheel2_adc_fault_p = find_fault("adcs_monitor.wheel2_fault.base");
            wheel3_adc_fault_p = find_fault("adcs_monitor.wheel3_fault.base");
            wheel_pot_fault_p = find_fault("adcs_monitor.wheel_pot_fault.base");
        }
