    ...
    */
    ...
    const std::vector<DownlinkProducer::FlowData> PAN::detumble_flows= {
...
{4, true, {"adcs_monitor.rwa_speed_rd.x", "adcs_monitor.rwa_speed_rd.y", "adcs_monitor.rwa_speed_rd.z", "adcs_monitor.rwa_torque_rd.x", "adcs_monitor.rwa_torque_rd.y", "adcs_monitor.rwa_torque_rd.z", "adcs_monitor.ssa_mode"}},
{5, true, {"attitude.pointer_vec1_current", "attitude.pointer_vec1_desired", "attitude.pointer_vec2_current", "attitude.pointer_vec2_desired"}},
{6, true, {"adcs_monitor.havt_device0", "adcs_monitor.havt_device1", "adcs_monitor.havt_device2", "adcs_monitor.havt_device3", "adcs_monitor.havt_device4", "adcs_monitor.havt_device5", "adcs_monitor.havt_device6", "adcs_monitor.havt_device7", "adcs_monitor.havt_device8", "adcs_monitor.havt_device9", "adcs_monitor.havt_device10", "adcs_monitor.havt_device11", "adcs_monitor.havt_device12", "adcs_monitor.havt_device13", "adcs_monitor.havt_device14", "adcs_monitor.havt_device15", "adcs_monitor.havt_device16", "adcs_monitor.havt_device17"}},
{7, true, {"dcdc.SpikeDock", "dcdc.ADCSMotor"}},
{8, false, {"attitude_estimator.w_bias_body", "attitude_estimator.p_body_eci_sigma_f", "attitude_estimator.w_bias_sigma_body", "attitude_estimator.mag_flag", "attitude_estimator.b_valid", "attitude_estimator.b_body"}},
{9, true, {"adcs_monitor.functional_fault.base", "piksi_fh.dead.base", "adcs_monitor.wheel2_fault.base", "adcs_monitor.wheel3_fault.base", "adcs_monitor.wheel_pot_fault.base", "prop.overpressured.base", "prop.pressurize_fail.base", "prop.tank2_temp_high.base", "prop.tank1_temp_high.base", "gomspace.low_batt.base", "gomspace.get_hk.base", "attitude_estimator.fault.base"}},
{10, true, {"gomspace.vbatt", "gomspace.cursun", "gomspace.cursys", "gomspace.temp.output1", "gomspace.temp.output2", "gomspace.temp.output3", "gomspace.temp.output4"}},
{11, false, {"gomspace.vboost.output1", "gomspace.vboost.output2", "gomspace.vboost.output3", "gomspace.curin.output1", "gomspace.curin.output2", "gomspace.curin.output3"}},
{12, false, {"gomspace.curout.output1", "gomspace.curout.output2", "gomspace.curout.output3", "gomspace.curout.output4", "gomspace.curout.output5", "gomspace.curout.output6", "gomspace.output.output1", "gomspace.output.output2", "gomspace.output.output3", "gomspace.output.output4", "gomspace.output.output5", "gomspace.output.output6"}},
{13, false, {"gomspace.counter_boot", "gomspace.bootcause", "gomspace.battmode", "gomspace.pptmode"}},
{14, false, {"gomspace.power_cycle_output1_cmd", "gomspace.power_cycle_output2_cmd", "gomspace.power_cycle_output3_cmd", "gomspace.power_cycle_output4_cmd", "gomspace.power_cycle_output5_cmd", "gomspace.power_cycle_output6_cmd", "gomspace.piksi_off"}},
{15, true, {"adcs.state", "prop.state", "radio.state", "piksi.state", "qfh.state"}},
...
{21, false, {"adcs_monitor.ssa_voltage0", "adcs_monitor.ssa_voltage1", "adcs_monitor.ssa_voltage2", "adcs_monitor.ssa_voltage3", "adcs_monitor.ssa_voltage4", "adcs_monitor.ssa_voltage5", "adcs_monitor.ssa_voltage6", "adcs_monitor.ssa_voltage7", "adcs_monitor.ssa_voltage8", "adcs_monitor.ssa_voltage9"}},
{22, false, {"adcs_monitor.ssa_voltage10", "adcs_monitor.ssa_voltage11", "adcs_monitor.ssa_voltage12", "adcs_monitor.ssa_voltage13", "adcs_monitor.ssa_voltage14", "adcs_monitor.ssa_voltage15", "adcs_monitor.ssa_voltage16", "adcs_monitor.ssa_voltage17", "adcs_monitor.ssa_voltage18", "adcs_monitor.ssa_voltage19"}},
{23, false, {"rel_orbit.pos", "rel_orbit.vel"}},
{24, false, {"rel_orbit.rel_pos", "rel_orbit.rel_vel", "rel_orbit.rel_pos_sigma", "rel_orbit.rel_vel_sigma"}},
{25, true, {"orbit.control.valve1", "orbit.control.valve2", "orbit.control.valve3", "orbit.control.valve4", "orbit.control.J_ecef", "orbit.control.alpha", "orbit.control.num_near_field_nodes"}},
{26, false, {"prop.cycles_until_firing", "prop.sched_intertank1", "prop.sched_intertank2"}},
