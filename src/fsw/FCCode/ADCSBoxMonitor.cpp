...
ADCSBoxMonitor::ADCSBoxMonitor(StateFieldRegistry &registry, 
    ...
    adcs_functional_fault("adcs_monitor.functional_fault_base", 1, control_cycle_count),
    wheel1_adc_fault("adcs_monitor.wheel1_fault_base", 1, control_cycle_count),
    wheel2_adc_fault("adcs_monitor.wheel2_fault_base", 1, control_cycle_count),
    wheel3_adc_fault("adcs_monitor.wheel3_fault_base", 1, control_cycle_count),
    wheel_pot_fault("adcs_monitor.wheel_pot_fault_base", 1, control_cycle_count)
    {
        // reserve memory
