...
class DockingSystem : public Devices::Device {
   public:
    ...
    TRACKED_CONSTANT(static constexpr unsigned char, motor_i1_pin, 14)
    //! Default pin for docking motor I2.
    TRACKED_CONSTANT(static constexpr unsigned char, motor_i2_pin, 15)
    //! Default pin for docking motor direction pin.
    TRACKED_CONSTANT(static constexpr unsigned char, motor_direction_pin, 16)
    //! Default pin for docking motor sleep pin.
    TRACKED_CONSTANT(static constexpr unsigned char, motor_sleep_pin, 17)
    //! Default pin for docking motor step.
    TRACKED_CONSTANT(static constexpr unsigned char, motor_step_pin, 39)
    //! Docking switch pin
    TRACKED_CONSTANT(static constexpr unsigned char, switch_pin, 36)
