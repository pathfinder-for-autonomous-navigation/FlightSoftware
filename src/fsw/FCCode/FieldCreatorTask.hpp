...
class FieldCreatorTask : public ControlTask<void> {
    public:
      ...
      FieldCreatorTask(StateFieldRegistry& r) : 
        ...
        failed_pressurize_f("prop.failed_pressurize_base", 1, TimedControlTaskBase::control_cycle_count),
        overpressured_f("prop.overpressured_base", 1, TimedControlTaskBase::control_cycle_count)
      {
          // Create the fields!
