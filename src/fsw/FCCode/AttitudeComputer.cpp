...
AttitudeComputer::AttitudeComputer(StateFieldRegistry& registry, unsigned int offset) :
    ...
    adcs_vec1_current_f("attitude_control.vec1_current", Serializer<lin::Vector3f>(0, 1, 100)),
    adcs_vec1_desired_f("attitude_control.vec1_desired", Serializer<lin::Vector3f>(0, 1, 100)),
    adcs_vec2_current_f("attitude_control.vec2_current", Serializer<lin::Vector3f>(0, 1, 100)),
    adcs_vec2_desired_f("attitude_control.vec2_desired", Serializer<lin::Vector3f>(0, 1, 100))
{
