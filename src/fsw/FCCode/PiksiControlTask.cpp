...
PiksiControlTask::PiksiControlTask(StateFieldRegistry &registry, 
    ...
    piksi(_piksi),
    pos_f("piksi.pos", Serializer<d_vector_t>(6771000,6971000, 26)),
    vel_f("piksi.vel", Serializer<d_vector_t>(7500, 7700, 18)),
    baseline_pos_f("piksi.baseline_pos", Serializer<d_vector_t>(0,2000, 21)),
