...
PiksiControlTask::PiksiControlTask(StateFieldRegistry &registry, 
    ...
    piksi(_piksi),
    pos_f("piksi.pos", Serializer<d_vector_t>(5000,9000,38)),
    vel_f("piksi.vel", Serializer<d_vector_t>(10000,12000,38)),
    baseline_pos_f("piksi.baseline_pos", Serializer<d_vector_t>(0,10000,38)),
