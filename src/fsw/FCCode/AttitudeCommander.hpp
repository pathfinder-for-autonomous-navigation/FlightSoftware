#ifndef ATTITUDE_COMMANDER_HPP_
#define ATTITUDE_COMMANDER_HPP_
 ...
 * of the spacecraft.
 */
class AttitudeCommander : public TimedControlTask<void> {
   public:
    /**
     ...
     * @param registry 
     */
    AttitudeCommander(StateFieldRegistry& registry, unsigned int offset);
