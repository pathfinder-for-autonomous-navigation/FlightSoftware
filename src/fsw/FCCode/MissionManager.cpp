    ...
    sat_designation_f("pan.sat_designation", Serializer<unsigned char>(2), 100)
{
    ...
    low_batt_fault_fp = static_cast<Fault*>(
            find_writable_field<bool>("gomspace.low_batt_base", __FILE__, __LINE__));
    adcs_functional_fault_fp = static_cast<Fault*>(
            find_writable_field<bool>("adcs_monitor.functional_fault_base", __FILE__, __LINE__));
    wheel1_adc_fault_fp = static_cast<Fault*>(
            find_writable_field<bool>("adcs_monitor.wheel1_fault_base", __FILE__, __LINE__));
    wheel2_adc_fault_fp = static_cast<Fault*>(
            find_writable_field<bool>("adcs_monitor.wheel2_fault_base", __FILE__, __LINE__));
    wheel3_adc_fault_fp = static_cast<Fault*>(
            find_writable_field<bool>("adcs_monitor.wheel3_fault_base", __FILE__, __LINE__));
    wheel_pot_fault_fp = static_cast<Fault*>(
            find_writable_field<bool>("adcs_monitor.wheel_pot_fault_base", __FILE__, __LINE__));
    failed_pressurize_fp = static_cast<Fault*>(
            find_writable_field<bool>("prop.failed_pressurize_base", __FILE__, __LINE__));
