...
namespace Propulsion {
  circular_buffer<float,10> tank_pressure_history;
...
namespace Piksi {
  circular_buffer<int,10> iar_history;
  circular_buffer<int,10> nsats_history;
  circular_buffer<bool,10> is_float_rtk_history;
  circular_buffer<bool,10> is_fixed_rtk_history;
