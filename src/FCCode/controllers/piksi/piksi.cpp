...
static void piksi_read() {
    dbg.println(debug_console::severity::INFO, "Reading Piksi data");
...
void RTOSTasks::piksi_controller(void *arg) {
    ...
    dbg.println(debug_console::severity::INFO, "Piksi controller process has started.");
    ...
    while(true) {
        ...
        if (!State::Hardware::check_is_functional(piksi)) {
            dbg.println(debug_console::severity::ERROR, "Piksi not functional.");
            if (!is_fake_piksi) {
                dbg.println(debug_console::severity::NOTICE, "Power cycling Piksi.");
            ...
            dbg.println(debug_console::severity::INFO, "Piksi functional.");
            piksi_read();
        }
