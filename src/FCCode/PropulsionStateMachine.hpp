...
private:
  ...
  Serializer<bool, bool, SerializerConstants::bool_sz>
...
public:
  ...
  static const std::array<std::string,
                          static_cast<unsigned int>(state_t::num_states)>
      state_names;
  static const std::array<std::string, static_cast<unsigned int>(
                                           state_transition_t::num_transitions)>
      transition_names;
...
protected:
  ...
  WritableStateField<gps_time_t, bool, SerializerConstants::gps_time_sz>
      firing_time;
