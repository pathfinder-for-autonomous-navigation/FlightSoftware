...
GomspaceController::GomspaceController(StateFieldRegistry &registry,
    ...
    : TimedControlTask<void>(registry, offset), gs(_gs), vboost_sr(0, 4000, 9),
      ...
      vbatt_sr(5000, 9000, 10), vbatt_f("gomspace.vbatt", vbatt_sr),

      curin_sr(0, 10, 10), curin1_f("gomspace.curin.output1", curin_sr),
      ...
      curout_sr(0, 10, 10), curout1_f("gomspace.curout.output1", curout_sr),
      ...
      output_sr(), output1_f("gomspace.output.output1", output_sr),
      ...
      temp_sr(-40, 125), temp1_f("gomspace.temp.output1", temp_sr),
      ...
      battmode_sr(0, 4), battmode_f("gomspace.battmode", battmode_sr),

      pptmode_sr(1, 2), pptmode_f("gomspace.pptmode", pptmode_sr) {
