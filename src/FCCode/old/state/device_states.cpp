...
namespace ADCS {
static Hardware::DeviceState adcs_gyroscope_state = {false, false, false, false,
                                                     1};
static Hardware::DeviceState adcs_magnetometer_1_state = {false, false, false,
                                                          false, 1};
static Hardware::DeviceState adcs_magnetometer_2_state = {false, false, false,
                                                          false, 1};
