...
enum EEPROM_ADDRESSES {
    ...
    HOURS_SINCE_SBDIX = offset + 0x30,          // 4-byte integer; counts hours since the last
    ...
    DEVICE_REBOOTS_SPIKE_AND_HOLD =
        offset + 0x68,  // 4-byte integer: number of times Spike and Hold has been rebooted
    DEVICE_REBOOTS_ADCS = offset + 0x6C,  // 4-byte integer: number of times ADCS has been rebooted
};

enum FINAL_STATES { NO_FINAL_STATE = 0, DOCKING = 1, DOCKED = 2, PAIRED = 3, SPACEJUNK = 4 };
