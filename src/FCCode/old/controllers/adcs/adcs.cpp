...
void RTOSTasks::adcs_controller(void *arg) {
    ...
    chThdCreateStatic(update_adcs_hat_workingArea, sizeof(update_adcs_hat_workingArea),
    ...
    chMtxLock(&State::Hardware::adcs_device_lock);
    if (State::Hardware::check_is_functional(adcs_system)) adcs_system->set_mode(Mode::ACTIVE);
