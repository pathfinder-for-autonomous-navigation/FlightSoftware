...
void Master::safe_hold() {
    ...
    State::write(State::Propulsion::propulsion_state, State::Propulsion::PropulsionState::DISABLED,
                 State::Propulsion::propulsion_state_lock);
    ...
    safe_hold_timer_thread =
        chThdCreateStatic(&safe_hold_timer_workingArea, sizeof(safe_hold_timer_workingArea),
