...
static State::Hardware::DeviceState temp_sensor_inner_device_state = {false, false, false, false,
                                                                      1};
static State::Hardware::DeviceState temp_sensor_outer_device_state = {false, false, false, false,
                                                                      1};
...
void hardware_setup() {
    ...
    Devices::system_output =
        new (device_heap) Devices::SystemOutput(system_output_device_name, Serial3);
    Devices::piksi = new (device_heap)
        Devices::FakePiksi(fake_piksi_device_name,
