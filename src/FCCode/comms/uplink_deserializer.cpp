...
void Comms::deserialize_uplink(const std::bitset<Comms::UPLINK_SIZE_BITS>& mes, Comms::Uplink* uplink) {
  ...
  std::bitset<7> bitset_5;
  for(int i = 0; i < 7; i++) bitset_5.set(i, mes[bitset_ptr++]);
  uplink->constant_0_id = Comms::expand_int(bitset_5, 0, 100);
  ...
  std::bitset<7> bitset_7;
  for(int i = 0; i < 7; i++) bitset_7.set(i, mes[bitset_ptr++]);
  uplink->constant_1_id = Comms::expand_int(bitset_7, 0, 100);
  ...
  std::bitset<7> bitset_9;
  for(int i = 0; i < 7; i++) bitset_9.set(i, mes[bitset_ptr++]);
  uplink->constant_2_id = Comms::expand_int(bitset_9, 0, 100);
  ...
  std::bitset<7> bitset_11;
  for(int i = 0; i < 7; i++) bitset_11.set(i, mes[bitset_ptr++]);
  uplink->constant_3_id = Comms::expand_int(bitset_11, 0, 100);
