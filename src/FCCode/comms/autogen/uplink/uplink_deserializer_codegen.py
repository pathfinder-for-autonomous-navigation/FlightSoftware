...
header_file += "#ifndef UPLINK_DESERIALIZER_HPP_\n"
header_file += "#define UPLINK_DESERIALIZER_HPP_\n\n"
header_file += "#include <bitset>\n"
header_file += "#include \"uplink_struct.hpp\"\n"
header_file += "#include \"../state/device_states.hpp\"\n\n"
header_file += "namespace Comms {\n"
header_file += "  void deserialize_uplink(const std::bitset<Comms::UPLINK_SIZE_BITS>& mes, Uplink* uplink);\n"
header_file += "}\n\n"
header_file += "#endif"
f = open("../../uplink_deserializer.hpp", "w")
f.write(header_file)
f.close()
