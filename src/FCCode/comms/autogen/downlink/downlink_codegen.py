...
def header_generator(fields):
    ...
    header_str += "  void serialize_packets(std::bitset<PACKET_SIZE_BITS> (&packets)[NUM_PACKETS], unsigned int downlink_no);\n"
    header_str += "}\n\n"
...
def frame_generator(fields):
    ...
    frame_str += "void Comms::serialize_packets(std::bitset<Comms::PACKET_SIZE_BITS> (&packets)[Comms::NUM_PACKETS], unsigned int downlink_no) {\n"
