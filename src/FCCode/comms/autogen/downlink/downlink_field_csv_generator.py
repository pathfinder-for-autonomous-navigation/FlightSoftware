...
MASTER_FIELDS = [
{ "group" : "master", "name" : "master_state",          "type" : "int",        "size" : 3, "min" : 0, "max" : 4 },
{ "group" : "master", "name" : "pan_state",             "type" : "int",        "size" : 4, "min" : 0, "max" : 11 },
{ "group" : "master", "name" : "boot_number",           "type" : "int",        "size" : 32, "min" : 0, "max" : MAX_INT },
{ "group" : "master", "name" : "last_uplink_time",      "type" : "gps time",   "size" : 48},
...
ADCS_FIELDS = [
{ "group" : "adcs", "name" : "adcs_state",                          "type" : "int",          "size" : 2, "min" : 0, "max" : 3 },
{ "group" : "adcs", "name" : "cmd_attitude",                        "type" : "quaternion",   "size" : 29 },
{ "group" : "adcs", "name" : "cur_attitude",                        "type" : "quaternion",   "size" : 29 },
...
PROPULSION_FIELDS = []
PROPULSION_FIELDS.append({ "group" : "propulsion", "name" : "propulsion_state",            "type" : "int",          "size" : 3, "min" : 0, "max" : 5 })
...
PROPULSION_FIELDS.append({ "group" : "propulsion", "name" : "firing_data.time",            "type" : "gps time",     "size" : 48 })
FIELDS.extend(PROPULSION_FIELDS)

PIKSI_FIELDS = [
{ "group" : "piksi", "name" : "recorded_current_time",              "type" : "gps time", "size" : 48 },
{ "group" : "piksi", "name" : "recorded_time_collection_timestamp", "type" : "int",      "size" : 32, "min" : 0, "max" : MAX_INT },
]
FIELDS.extend(PIKSI_FIELDS)

GNC_FIELDS = [
{ "group" : "gnc", "name" : "current_time",                     "type" : "gps time", "size" : 48 },
...
ADCS_HISTORY_FIELDS.append({ "group" : "adcs_history", "name" : "attitude_cmd_history",      "type" : "quaternion", "size" : 29 })
ADCS_HISTORY_FIELDS.append({ "group" : "adcs_history", "name" : "attitude_history",          "type" : "quaternion", "size" : 29 })
ADCS_HISTORY_FIELDS.append({ "group" : "adcs_history", "name" : "attitude_fast_history",     "type" : "quaternion", "size" : 29 })
...
PROPULSION_HISTORY_FIELDS.append({ "group" : "propulsion_history", "name" : "inner_tank_temperature_history", "type" : "temperature", "size" : 9 })
PROPULSION_HISTORY_FIELDS.append({ "group" : "propulsion_history", "name" : "outer_tank_temperature_history", "type" : "temperature", "size" : 9 })
...
print "Full data size: " + str(size / 8) + " bytes"
compressed_size = sum([field["total_size"] for field in FIELDS])
print "Compressed data size: " + str(compressed_size/8) + " bytes"
print "Compression ratio: " + str(100 - 100 * (compressed_size + 0.0) / size)
print "Required # of packets: " + str(int(math.ceil(compressed_size / 8.0 / 70)))
