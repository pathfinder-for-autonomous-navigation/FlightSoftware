...
PROPULSION_FIELDS.append({ "group" : "propulsion", "name" : "is_firing_planned",           "type" : "bool" })
PROPULSION_FIELDS.append({ "group" : "propulsion", "name" : "is_firing_planned_by_uplink", "type" : "bool" })
