...
{7, false, {"adcs_monitor.functional_fault.base", "piksi_fh.dead.base", "adcs_monitor.wheel2_fault.base", "adcs_monitor.wheel3_fault.base", "adcs_monitor.wheel_pot_fault.base", "prop.overpressured.base", "prop.pressurize_fail.base", "prop.tank2_temp_high.base", "prop.tank1_temp_high.base", "gomspace.low_batt.base", "gomspace.get_hk.base", "attitude_estimator.fault.base"}},
{8, false, {"gomspace.vbatt", "gomspace.cursun", "gomspace.cursys", "gomspace.temp.output1", "gomspace.temp.output2", "gomspace.temp.output3", "gomspace.temp.output4"}},
...
{13, false, {"adcs.state", "prop.state", "radio.state", "piksi.state", "qfh.state"}},
{14, false, {"adcs_monitor.havt_device0", "adcs_monitor.havt_device1", "adcs_monitor.havt_device2", "adcs_monitor.havt_device3", "adcs_monitor.havt_device4", "adcs_monitor.havt_device5", "adcs_monitor.havt_device6", "adcs_monitor.havt_device7", "adcs_monitor.havt_device8", "adcs_monitor.havt_device9", "adcs_monitor.havt_device10", "adcs_monitor.havt_device11", "adcs_monitor.havt_device12", "adcs_monitor.havt_device13", "adcs_monitor.havt_device14", "adcs_monitor.havt_device15", "adcs_monitor.havt_device16", "adcs_monitor.havt_device17"}},
{15, false, {"adcs_monitor.rwa_speed_rd.x", "adcs_monitor.rwa_speed_rd.y", "adcs_monitor.rwa_speed_rd.z", "adcs_monitor.rwa_torque_rd.x", "adcs_monitor.rwa_torque_rd.y", "adcs_monitor.rwa_torque_rd.z", "adcs_monitor.ssa_mode"}},
{16, false, {"prop.tank1.valve_choice", "prop.tank2.pressure", "prop.tank2.temp", "prop.tank1.temp", "prop.num_prop_firings"}},
{17, false, {"attitude.pointer_vec1_current", "attitude.pointer_vec1_desired", "attitude.pointer_vec2_current", "attitude.pointer_vec2_desired"}},
{18, false, {"radio.err", "radio.last_comms_ccno"}},
{19, false, {"adcs_monitor.mag1_vec.x", "adcs_monitor.mag1_vec.y", "adcs_monitor.mag1_vec.z", "adcs_monitor.mag2_vec.x", "adcs_monitor.mag2_vec.y", "adcs_monitor.mag2_vec.z", "adcs_monitor.gyr_vec.x", "adcs_monitor.gyr_vec.y", "adcs_monitor.gyr_vec.z", "adcs_monitor.ssa_vec"}},
...
{25, false, {"docksys.docked"}},
{26, false, {"orbit.control.valve1", "orbit.control.valve2", "orbit.control.valve3", "orbit.control.valve4", "orbit.control.J_ecef", "orbit.control.alpha", "orbit.control.num_near_field_nodes"}},
