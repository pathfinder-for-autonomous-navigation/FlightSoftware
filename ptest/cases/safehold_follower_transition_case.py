...
class SafeholdFollowerTransitionCase(SingleSatOnlyCase):
    ...
    #Case 3: Standby
      ...
      if(self.firstStandby):
        ...
        if currCycle - self.tempTime < 70:
          ...
          #move to follower(set sat designation to follower)
          self.ws("pan.sat_designation", 2)
          #self.ws("pan.state",4)

    #Case 4: Follower
    elif currState == 4 :
      self.firstStandby = True   
      self.logger.put("In Follower")
